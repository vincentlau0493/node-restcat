...
function auth2(restcat) {
	if (restcat.authorization) return restcat.authorization.authorize.bind(restcat.authorization);
...
Restcat.prototype.register = function() {
	...
	//get all
	router.get(requestUrl,auth(self), auth2(self), function(req, res) {
		bundle = {};
	...
	//get by id
	router.get(requestUrl+':id',auth(self), auth2(self), function(req, res) {
		bundle = {};
	...
	//create a document
	router.post(requestUrl,auth(self), auth2(self), function(req, res) {
		// console.log(req);
	...
	//update document
	router.post(requestUrl+':id',auth(self), auth2(self), function(req, res) {
